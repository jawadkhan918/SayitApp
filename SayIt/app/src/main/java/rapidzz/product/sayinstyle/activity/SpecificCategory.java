...
import rapidzz.product.sayinstyle.model.DialoguesList;
...
//    private static List<Dialogues> mDialogueList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      */  adView = new AdView(this);
        ...
        linear = (RelativeLayout) findViewById(R.id.main_layout);
        internetLinear = (LinearLayout) findViewById(R.id.checkInternetLayout);
...
*/
            ...
            internetLinear.setVisibility(View.VISIBLE);
...
//        Toast.makeText(getApplicationContext(),"this called",Toast.LENGTH_SHORT).show();
    ...
    public void retry(View view) {
        if (CheckInternet.isNetConnected(getApplicationContext())) {
            internetLinear.setVisibility(View.GONE);
