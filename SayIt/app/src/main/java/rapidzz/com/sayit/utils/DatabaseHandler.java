package rapidzz.com.sayit.utils;
...
import rapidzz.com.sayit.model.Favorities;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "com.rapidzz.islah";
    ...
    private static final String KEY_CAT_TITLE = "catTitle";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_FAVORITES_TABLE = "CREATE TABLE " + TABLE_FAVORITES + "("
                ...
                +KEY_CAT_TITLE + " TEXT," + KEY_LINK + " TEXT," + KEY_USE + " TEXT" + ")";
...
//        db.execSQL(CREATE_CATEGORIES_TABLE);
    ...
    public void addFavourite(Dialogues fvrt) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();

        values.put(KEY_ID, fvrt.getId());
        values.put(KEY_NAME, fvrt.getDialogue()); // Contact Name
        values.put(KEY_CAT_TITLE,fvrt.getmCatTitle());
        values.put(KEY_LINK, fvrt.getLink());
        ...
        if (cursor.moveToFirst()) {
            do {
                FavoritiesList.get().addFavorities(
                        new Favorities(cursor.getInt(0), cursor.getString(1), cursor.getString(2),cursor.getString(3)));
...
*/
   ...
   /* public ArrayList<Dialogues> getAllTrendings() {

        String selectQuery = "SELECT  * FROM " + TABLE_TRENDING;
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);
        ArrayList<Dialogues> dialoguesList = new ArrayList<Dialogues>();
        if (cursor.moveToFirst()) {
            do {
