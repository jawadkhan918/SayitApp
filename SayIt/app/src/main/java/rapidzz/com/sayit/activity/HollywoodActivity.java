...
/**
 * Created by Talhazk on 05-Apr-16.
 */
...
import rapidzz.com.sayit.*;
import rapidzz.com.sayit.app.Config;
import rapidzz.com.sayit.fragment.InviteFragment;
import rapidzz.com.sayit.model.Category;
...
public class HollywoodActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
// finally change the color
        ...
        if (CheckInternet.isNetConnected(getApplicationContext())) {
            ...
            pDialog = new ProgressDialog(HollywoodActivity.this);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                if (catStatus.equals("english")||catStatus.equals("both")) {
...
//
            VHitem.categoryStatus.setText("English");
            VHitem.categoryStatus.setTextColor(Color.parseColor("#FFFFFF"));

            VHitem.categoryAudios.setText(currentItem.getCatCountEnglish());
    ...
    public void saveInSharedPref(int value) {
        SharedPreferences sp = this.getSharedPreferences(
                "rapidzz.com.sayit", Context.MODE_PRIVATE);
